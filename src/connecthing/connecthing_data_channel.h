#ifndef CONNECTHING_DATA_CHANNEL_H_
#define CONNECTHING_DATA_CHANNEL_H_
...
class ConnecthingDataChannelObserver {
 public:
  ~ConnecthingDataChannelObserver() {}
...
class ConnecthingDataChannel : public RTCDataManager {
  struct Thunk : webrtc::DataChannelObserver,
                 std::enable_shared_from_this<Thunk> {
    ConnecthingDataChannel* p;
 ...
 public:
  ConnecthingDataChannel(ConnecthingDataChannelObserver* observer)
      : observer_(observer) {}
 ...
 private:
  ...
  std::map<std::string, webrtc::scoped_refptr<webrtc::DataChannelInterface>>
      labels_;
  ConnecthingDataChannelObserver* observer_;

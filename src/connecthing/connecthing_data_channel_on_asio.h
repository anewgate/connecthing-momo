#ifndef CONNECTHING_DATA_CHANNEL_ON_ASIO_H_
#define CONNECTHING_DATA_CHANNEL_ON_ASIO_H_
...
#include "connecthing_data_channel.h"

class ConnecthingDataChannelOnAsio : public RTCDataManager {
  struct AsioPoster : ConnecthingDataChannelObserver {
    AsioPoster(boost::asio::io_context& ioc,
               ConnecthingDataChannelObserver* observer)
 ...
 public:
  ConnecthingDataChannelOnAsio(boost::asio::io_context& ioc,
                               ConnecthingDataChannelObserver* observer)

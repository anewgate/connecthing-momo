...
ConnecthingSession::ConnecthingSession(
...
void ConnecthingSession::Run() {
  DoRead();
}

void ConnecthingSession::DoRead() {
  ...
  boost::beast::http::async_read(
      ...
      std::bind(&ConnecthingSession::OnRead, shared_from_this(),
                std::placeholders::_1, std::placeholders::_2));
}

void ConnecthingSession::OnRead(boost::system::error_code ec,
...
void ConnecthingSession::OnWrite(boost::system::error_code ec,
                                 std::size_t bytes_transferred,
                                 bool close) {
  boost::ignore_unused(bytes_transferred);
...
void ConnecthingSession::DoClose() {
  // Send a TCP shutdown
  boost::system::error_code ec;
...
ConnecthingSession::CreateOKWithJSON(
